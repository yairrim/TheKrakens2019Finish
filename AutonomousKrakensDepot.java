...
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.Position.LEFT;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.Position.MIDDLE;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.Position.RIGHT;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.UPdDir.Down;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.UPdDir.Release;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.UPdDir.SlightlyDown;
import static org.firstinspires.ftc.teamcode.AutonomousKrakensDepot.UPdDir.Up;


@Autonomous(name ="Auto Depot",group="Depot")
public class AutonomousKrakensDepot extends LinearOpMode {
    ...
    public void posR() {
        ...
        gyroTurn(0.5, -20);
        CubeToLander();
        UpDownArmEncoder(0.4,SlightlyDown);
        gyroDrive(0.2, -10, 0);
        gyroTurn(0.5, -20);
        gyroDrive(1, -70, -27);
        gyroTurn(0.5, 27);
    ...
    public void CubeToLander(){
        ...
        SortMineral();
        UpDownArmEncoder(0.7,SlightlyDown);
    }
    enum Position{
        RIGHT,
        LEFT,
    ...
    public void DropId() {
        ...
        idtime.reset();
        while(opModeIsActive() &&idtime.seconds()<1){
    ...
    public void UpDownArmEncoder(double speed, UPdDir Dir) {
        ...
        if (opModeIsActive() && Dir == Up){
            newTarget = (int) (robot.ArmUpDownR.getCurrentPosition() + 1650);
        }
        ...
        if (opModeIsActive() && Dir == SlightlyDown){
            newTarget = (int) (robot.ArmUpDownR.getCurrentPosition() - 220);
            speed=-speed;
        }
