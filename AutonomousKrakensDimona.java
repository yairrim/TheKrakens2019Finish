...
@Autonomous(name ="Autonomous krakens 15768 Dimona")
@Disabled
public class AutonomousKrakensDimona extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive()) {
                ...
                activetime.reset();
                while(opModeIsActive() && activetime.seconds()<4){
                    robot.ArmUpDown.setPower(0.2);
                    robot.ArmUpDownR.setPower(0.2);
                }
