...
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.Position.LEFT;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.Position.MIDDLE;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.Position.RIGHT;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.UdDir.Down;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.UdDir.PartDown;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.UdDir.Release;
import static org.firstinspires.ftc.teamcode.AutonomousCrater2Sample.UdDir.Up;

@Autonomous(name ="Auto Carter 2 Sample",group="Crater")

public class AutonomousCrater2Sample extends LinearOpMode {
    ...
    public void UpDownArmEncoder(double speed,UdDir Dir) {
        ...
        if (opModeIsActive() && Dir == PartDown){
            newTarget = (int) (robot.ArmUpDownR.getCurrentPosition() - 150);
            speed=-speed;
        }
        ...
        if (opModeIsActive() && Dir == Up || Dir == Release){
            while(opModeIsActive() && !robot.MotorInPosition(robot.ArmUpDownR)){
                ...
                robot.WireController.setPower(-0.15);
    ...
    public void ToDepotAndSample(){
        ...
        double SamplePosition=getGyroAngle();
        gyroDrive(1,35,SamplePosition);
